	...
	return (
		<div className="section steps">
			...
			<div className="step__bloc">
				<div className="step__bloc--position">
							...
							<div className="single__step--flex">
								<li>
									...
									<p>
										...
										possibles (description, style, photo, emplacement, taille,
								...
								<li>
									...
									<p>
										...
										répondre à toutes les demandes, notamment les projets
										“cover”.
									</p>
									<p>
				...
				<div className="step__bloc--position">
					<div className="step__bloc--flex">
						<div className="single__step">
							...
							<ul>
								<li>
									- Rencontre gratuite afin d’approfondir vos besoins et
									attentes
								</li>
						...
						<div className="single__step">
							...
							<ul>
								...
								<li>
									- Rencontre intermédiaire et finale en fonction de
									l’importance de votre projet afin de valider tous les
									paramètres avant la réalisation du dessin.
								</li>
							</ul>
						</div>
					</div>
