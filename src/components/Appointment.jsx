		...
		<div className="section" id="appointment">
			<div className="appointment--opacity">
				<div className="appointment__time">
					...
					<p>
						<i>
							Pour un meilleur suivi et répondre au mieux à vos attentes, merci
							de nous contacter Robin uniquement par E-mail.
						</i>
					</p>
				...
				<div className="appointment__location">
					...
					<p>
						97122 Baie Mahault (ZI JARRY – face à la nouvelle concession Jeep, à
						l’étage de Renée Boulangerie)
					</p>
					<div>
						<iframe
							title="Adresse salon"
				...
				<div className="appointment__price">
					...
					<p>
						Les retouches, parfois nécessaires en finition, sont comprises dans
						le prix.
					</p>
				</div>
			</div>
